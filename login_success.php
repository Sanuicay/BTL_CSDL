				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-6 col-12">
						<div class="right-bar">
							...
							<div class="sinlge-bar">
								<!-- login button -->
								<a href="#" class="btn animate" style="background-color: #4CAF50; color: white; padding: 5px; text-align: center; text-decoration: none; display: inline-block; font-size: 14px; margin: 0px; cursor: pointer; border-radius: 12px;">Logout</a>
							</div>
						</div>
					</div>
				</div>
