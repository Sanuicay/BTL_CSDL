...
-- Insert sample data into account while checking foreign key constraints
...
('ACC005', 'user5', 'pass12345', 'user5@example.com', '1234567895', 'FirstName5', 'LastName5', 35),
('ACC006', 'user6', 'pass12345', 'user6@example.com', '1234567896', 'FirstName6', 'LastName6', 30),
('ACC007', 'user7', 'pass12345', 'user7@example.com', '1234567897', 'FirstName7', 'LastName7', 28),
('ACC008', 'user8', 'pass12345', 'user8@example.com', '1234567898', 'FirstName8', 'LastName8', 33),
('ACC009', 'user9', 'pass12345', 'user9@example.com', '1234567899', 'FirstName9', 'LastName9', 29);
...
-- rewrite the above query with `` to avoid conflict with SQL keywords

-- Fetch all employee info (from Employee table and Account table) with the following columns: EmployeeID, FirstName, LastName, Email, PhoneNumber, StartDate, Status, SuperiorID, Username, Password, Age). DO NOT use the LastName, Firtname, Email, PhoneNumber from Employee table.
ELECT e.EmployeeID, CONCAT(a.FirstName, ' ', a.LastName) AS EmployeeName, e.StartDate, e.Status, CONCAT(s.FirstName, ' ', s.LastName) AS SuperiorName
FROM Employee e LEFT JOIN Account a ON e.EmployeeID = a.AccountID LEFT JOIN Employee s ON e.SuperiorID = s.EmployeeID;
